...
from reportmaker.constants import DATETIME_FORMAT
from reportmaker.controllers.report import report
...
class App(object):
    ...
    def __init__(self, config):
        ...
        # load routes
        self.app.add_route('/v1/reports', report())
